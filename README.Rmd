...
###### Version : [`r getNamespaceVersion("ammistability")`](https://ajaygpb.github.io/ammistability/); Copyright (C) 2017-`r  format(Sys.Date(), "%Y")`: [ICAR-DGR](http://www.dgr.org.in/); License: [GPL-2|GPL-3](https://www.r-project.org/Licenses/)
...
if (url.exists(chkurl)) {
  ...
  chklink <- "(https://cran.r-project.org/web/checks/check_results_ajaygpb_at_yahoo.co.in.html)"
}
