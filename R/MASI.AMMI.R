...
#' style="text-decoration:overline"> &sum;<sup>N';</sup><sub
#' style="line-height: 1.8; margin-left: -2ex;">n=1</sub> PC<sup>2</sup><sub
#' style="line-height: 1.8; margin-left: -1ex;">n</sub> &times;
#' &theta;<sup>2</sup><sub style="line-height: 1.8; margin-left:
...
#' percentage sum of squares explained by the \ifelse{html}{\out{<i>n</i>}}{\eqn{n}}th principal component
#' interaction effect.
#'
