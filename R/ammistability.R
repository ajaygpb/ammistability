...
#' model.
#'
#' \describe{ \item{\link[AMMIStbP:AMGE.AMMI]{Sum Across Environments of GEI
#' Modelled by AMMI (AMGE)}}{Sneller et al., 1997}
#' \item{\link[AMMIStbP:ASI.AMMI]{AMMI Stability Index (ASI)}}{Jambhulkar et
#' al., 2014; Jambhulkar et al., 2015; Jambhulkar et al., 2017}
#' \item{\link[AMMIStbP:MASV.AMMI]{AMMI Stability Value (ASV)}}{Purchase 1997;
#' Purchase et al., 1999; Purchase et al., 2000}
#' \item{\link[AMMIStbP:ASTAB.AMMI]{AMMI Based Stability Parameter (ASTAB)}}{Rao
#' and Prabhakaran, 2005} \item{\link[AMMIStbP:AVAMGE.AMMI]{Sum Across
#' Environments of Absolute Value of GEI Modelled by AMMI (AVAMGE)}}{Zali et
#' al., 2012} \item{\link[AMMIStbP:DA.AMMI]{Annicchiarico's D Parameter
#' (DA)}}{Annicchiarico, 1997} \item{\link[AMMIStbP:DZ.AMMI]{Zhang's D Parameter
#' (DZ)}}{Zhang, 1998} \item{\link[AMMIStbP:EV.AMMI]{Averages of the Squared
#' Eigenvector Values (EV)}}{Zobel, 1994}
#' \item{\link[AMMIStbP:FA.AMMI]{Stability Measure Based on Fitted AMMI Model
#' (FA)}}{Raju, 2002} \item{\link[AMMIStbP:MASI.AMMI]{Modified AMMI Stability
#' Index (MASI)}}{Ajay et al., 2018} \item{\link[AMMIStbP:MASV.AMMI]{Modified
#' AMMI Stability Value (MASV)}}{Zali et al., 2012}
#' \item{\link[AMMIStbP:SIPC.AMMI]{Sums of the Absolute Value of the IPC Scores
#' (SIPC)}}{Sneller et al., 1997} \item{\link[AMMIStbP:ZA.AMMI]{Absolute Value
...
#' @export
#'
#' @seealso \code{\link[agricolae]{AMMI}}, \code{\link[AMMIStbP]{AMGE.AMMI}},
#'   \code{\link[AMMIStbP]{ASI.AMMI}}, \code{\link[AMMIStbP]{ASTAB.AMMI}},
#'   \code{\link[AVAMGE]{AMGE.AMMI}}, \code{\link[AMMIStbP]{DA.AMMI}},
#'   \code{\link[AMMIStbP]{DZ.AMMI}}, \code{\link[AMMIStbP]{EV.AMMI}},
#'   \code{\link[AMMIStbP]{FA.AMMI}}, \code{\link[AMMIStbP]{MASV.AMMI}},
#'   \code{\link[AMMIStbP]{SIPC.AMMI}}, \code{\link[AMMIStbP]{ZA.AMMI}},
