...
#### `AMGE.AMMI()`
```{r, runCode, code = getCode("AMGE.AMMI", "ammistability")}
```

#### `ASI.AMMI()`
```{r, runCode, code = getCode("ASI.AMMI", "ammistability")}
```

#### `ASTAB.AMMI()`
```{r, runCode, code = getCode("ASTAB.AMMI", "ammistability")}
```

#### `AVAMGE.AMMI()`
```{r, runCode, code = getCode("AVAMGE.AMMI", "ammistability")}
```

#### `DA.AMMI()`
```{r, runCode, code = getCode("DA.AMMI", "ammistability")}
```

#### `DZ.AMMI()`
```{r, runCode, code = getCode("DZ.AMMI", "ammistability")}
```

#### `EV.AMMI()`
```{r, runCode, code = getCode("EV.AMMI", "ammistability")}
```

#### `FA.AMMI()`
```{r, runCode, code = getCode("FA.AMMI", "ammistability")}
```

#### `MASV.AMMI()`
```{r, runCode, code = getCode("MASI.AMMI", "ammistability")}
```

#### `SIPC.AMMI()`
```{r, runCode, code = getCode("SIPC.AMMI", "ammistability")}
```
